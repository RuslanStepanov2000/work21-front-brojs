        ...
        <section className="section">
          <div className="container-lg mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register?role=student" className="btn-primary inline-flex items-center justify-center gap-2">
                Я студент
                <ArrowRight className="w-5 h-5" />
              </Link>
              <Link to="/register?role=customer" className="btn-outline inline-flex items-center justify-center gap-2">
                Я заказчик
              </Link>
            </div>
          </div>
