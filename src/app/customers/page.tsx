      ...
      <main className="pt-16">
          ...
          <div className="container-lg mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/register?role=customer" className="btn-primary inline-flex items-center justify-center gap-2 text-lg">
                  Создать проект
                  <ArrowRight className="w-5 h-5" />
                </Link>
                <Link to="/how-it-works" className="btn-outline inline-flex items-center justify-center gap-2 text-lg">
                  Узнать больше
                </Link>
              </div>
            </div>
        ...
        <section className="section">
          <div className="container-lg mx-auto text-center">
            ...
            <Link to="/register?role=customer" className="btn-primary inline-flex items-center gap-2 text-lg">
              Создать проект
              <ArrowRight className="w-5 h-5" />
            </Link>
          </div>
